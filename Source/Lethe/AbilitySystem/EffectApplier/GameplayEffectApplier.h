...
struct LETHE_API FGameplayEffectApplier
{
	 ...
	 */
	virtual void ApplyEffect(const UGameplayAbility* OwningAbility, AActor* TargetActor) const;
	 ...
	 */
	virtual bool TryPrepareSpecHandles(UAbilitySystemComponent* SourceASC, const FGameplayEffectContextHandle& InContextHandle, TArray<FGameplayEffectSpecHandle>& OutSpecHandles, const bool bPreview = false) const;
